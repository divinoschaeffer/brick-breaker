...
### Installation de SDL/SDL_ttf/SDL_image
...
```
cd existing_repo
git remote add origin https://git.unistra.fr/bdam/brick-breaker.git
git branch -M main
...
- [ ] [Set up project integrations](https://git.unistra.fr/bdam/brick-breaker/-/settings/integrations)
